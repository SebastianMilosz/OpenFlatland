...
public:
	 ...
	 */
    void addItem( codeframe::cSerializable* propertyObject);

    void addPropertyRecursivity( QProperty* propertyIteam, codeframe::cSerializable *propertyObject );
	 ...
	 */
    void updateItem ( codeframe::cSerializable* propertyObject, const QModelIndex& parent = QModelIndex() ) ;
...
private slots:
    void OnPropertyChanged( codeframe::Property* prop );

private:
	/// The Root Property for all objects
    QProperty*									m_rootItem;
