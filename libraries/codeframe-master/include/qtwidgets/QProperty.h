 ...
 */
class QProperty : public QObject, public sigslot::has_slots<>
{
	Q_OBJECT

    void slotPropertyChanged( codeframe::Property* prop );
...
public:
	 ...
	 */
    QProperty( const QString& name = QString(), codeframe::Property* propertyObject = 0, QObject* parent = 0 );
     ...
     * @return int
     */
    virtual codeframe::eKind type(int role = Qt::UserRole) const;
	 ...
	 */
    codeframe::Property* propertyObject() {return m_propertyObject;}
	 ...
	 * @return Property
	 */
    codeframe::Property* findPropertyObject( QObject* propertyObject );

signals:
    void valueChanged( codeframe::Property* prop );
...
protected:
    codeframe::Property* m_propertyObject;
    QString              m_hints;
