...
#define QPropertyEditor_VERSION 1.0
...
public:
	 ...
	 */
    typedef QProperty* (*UserTypeCB)(const QString& name, QObject* propertyObject, QProperty* parent);
	 ...
	 */
    void addObject( codeframe::cSerializable* propertyObject );
	 ...
	 *        managed by the QPropertyModel associated with this view
	 */
    void setObject( codeframe::cSerializable* propertyObject);
	 ...
	 */
    void updateObject( codeframe::cSerializable *propertyObject);
