...
namespace utilities
{
    namespace debug
    {
        ...
        class cLog
        {
            public:
                ...
                class cLogEntryContainer
                {
                    public:
                        ...
                        struct sLogEntry
                        {
                            sLogEntry(int loglevel, const std::string& text, const std::string& datePoint, const std::string& timePoint,
                                      const std::string& filePoint, const std::string& methodPoint, int linePoint, const std::string& Mac = "", const std::string& IP = "127.0.0.1", const std::string& Port = "");
                        ...
                        void AddEntry( int level, const std::string& text, const std::string& datePoint, const std::string& timePoint,
                                    const std::string& filePoint, const std::string& methodPoint, int linePoint,
                                    const std::string& mac, const std::string& iP, const std::string& port );

                        void SaveAsCSV( const std::string& path );
                        void SaveAsHTML( const std::string& path );
                ...
                signal4<const std::string&, const std::string&, const std::string&, int> OnMessage;

                std::string LogPath;

                static cLog& GetInstance( const std::string& date = "",
                ...
                cLog& operator << ( const std::string& s );                 // text [string]
                ...
                static void Flush( const std::string& path, int mode );
            ...
            private:
                cLog();
                void Message( const std::string& title, const std::string& msg, int type , int debugLevel );
